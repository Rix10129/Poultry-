...
import { LedgerFinder } from "@/components/accounts/ledger-finder"
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Find a customer, supplier, or account&rsquo;s transaction history</p>
        </div>
      </div>

      <div className="rounded-xl border border-slate-200 bg-white p-6">
        <LedgerFinder customers={customers} suppliers={suppliers} accounts={accounts} />
      </div>
    </div>
  )
}
